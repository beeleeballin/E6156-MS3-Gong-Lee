...
INSERT INTO Post (Title, User_ID, Time, Label, Content) VALUES ('Welcome to the blog!', 1, '2022-10-13 14:34:25', 'Administrative', "This is our first post. Enjoy the thread!");
INSERT INTO Post (Title, User_ID, Time, Location_ID, Content) VALUES ('Friday night badminton?', 2, '2022-10-14 07:15:22', 1, "I'm going to play this evening. Who's coming?");
INSERT INTO Post (Title, User_ID, Time, Location_ID, Label, Content) VALUES ('Found a green water bottle', 3, '2022-10-14 22:03:49', 1, 'Lost and Found', "Did somebody leave their water bottle by the bench? Reach out if it's yours!");
INSERT INTO Post (Title, User_ID, Time, Location_ID, Label, Content) VALUES ('Badminton at Blue Gym', 4, '2022-10-16 11:57:34', 2, 'Call for Partners', "I'm thinking of playing on Monday over at the main campus. Let's team up if you're thinking of going too.");

INSERT INTO Response (Post_ID, User_ID, Time, Content) VALUES (1, 5, '2022-10-13 15:41:34', "Great work! I'm excited about this :)");
INSERT INTO Response (Post_ID, User_ID, Time, Content) VALUES (1, 3, '2022-10-13 21:48:12', "Finally an official thread for announcements");
INSERT INTO Response (Post_ID, User_ID, Time, Content) VALUES (2, 3, '2022-10-14 11:13:18', "I'll see you there");
INSERT INTO Response (Post_ID, User_ID, Time, Content) VALUES (3, 1, '2022-10-15 09:26:20', "I think it might be Zheyan's");
INSERT INTO Response (Post_ID, User_ID, Time, Content) VALUES (3, 4, '2022-10-15 13:28:45', "No it's not I have a pink bottle");
INSERT INTO Response (Post_ID, User_ID, Time, Content) VALUES (4, 5, '2022-10-16 21:35:14', "I'll be on main campus too. Want to grab dinner?");

INSERT INTO Post_Thumbs (Post_ID, User_ID) VALUES (1, 5);
INSERT INTO Post_Thumbs (Post_ID, User_ID) VALUES (1, 2);
INSERT INTO Post_Thumbs (Post_ID, User_ID) VALUES (1, 4);
INSERT INTO Post_Thumbs (Post_ID, User_ID) VALUES (1, 3);
INSERT INTO Post_Thumbs (Post_ID, User_ID) VALUES (2, 3);
INSERT INTO Post_Thumbs (Post_ID, User_ID) VALUES (2, 5);
INSERT INTO Post_Thumbs (Post_ID, User_ID) VALUES (2, 4);
INSERT INTO Post_Thumbs (Post_ID, User_ID) VALUES (3, 1);
INSERT INTO Post_Thumbs (Post_ID, User_ID) VALUES (4, 5);
INSERT INTO Post_Thumbs (Post_ID, User_ID) VALUES (4, 2);

INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (1, 4);
INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (2, 2);
INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (2, 1);
INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (2, 3);
INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (3, 3);
INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (3, 5);
INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (5, 2);
INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (5, 3);
INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (5, 1);
INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (5, 5);
INSERT INTO Response_Thumbs (Response_ID, User_ID) VALUES (6, 4);
